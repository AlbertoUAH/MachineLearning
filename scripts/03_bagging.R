...
#   -> Diria que 10 + 1000 o 10 + 500 (500 parece ser una buena opcion)
...
#-- Distribucion de la tasa de error
#   Modelos candidatos: 10 + 500 ; 10 + 1000
...
# Por lo general, si. Por ello, elegimos como modelos candidatos 10 + 500 y 10 + 1000
...
#   Elegiria un modelo con 10 nodesize y sampsize 500
...
#---- Estadisticas
# Por tasa fallos --------------- auc
#   avnnet modelo 2          bagging modelo 1
#  bagging modelo 2          bagging modelo 2
#  bagging modelo 1          avnnet  modelo 1
