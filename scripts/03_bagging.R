...
#   Con sampsize 1000 - 2000, empleando 5-10-20-30 nodesize se obtiene practicamente la misma tasa de error
...
#   Nuevamente, con sampsize 1000-2000, a tasa AUC empleando 5-10-20-30 nodesize es similar a la obtenida con
...
# ¿Y en relacion al nodesize? Podemos probar inicialmente con 20, 30 y 40

# Nodesize 20: 1000-1500 parece ser una buena opcion (aunque en este ultimo presenta "alta" varianza en comparacion
# con una submuestra de 1000 observaciones), aunque la tasa de error es ligeramente menor
nodesizes.1 <- list(20)
...
#-- Distribucion de la tasa de error
#   Modelos candidatos: 30+2000 - 20+1500 - 40+2500 (orden descendente)
...
#-- Distribucion del AUC
#   Mejor resultado: 20 + 1500 - 20+1000 - 30+2000  30+1500
union_bagging_modelo1$modelo <- with(union_bagging_modelo1,
...
#   -> Dada la menor variabilidad que presenta con 10 repeticiones (tanto en AUC como en tasa de fallos),
#      elegimos el modelo nodesize 20 + sampsize 1000
...
# Del mismo modo que sucedia con el modelo 1, con sampsize 1000-2000 se obtienen unos modelos cuyos valores
# de error y AUC son muy similares a los obtenidos con el conjunto total de observaciones. Ademas, podemos
# estudiar los modelos a partir de valores de nodesize como 20, 30 o 40, principalmente. Si necesitamos reducir
