...
svm_5_rep[svm_5_rep$Modelo == 1, ] %>% ggplot() + geom_point(aes(C, Accuracy)) + ggtitle("SVM Lineal Modelo 1")
ggsave("./charts/SVM/lineal/svm_lineal_modelo1.png")

svm_5_rep[svm_5_rep$Modelo == 2, ] %>% ggplot() + geom_point(aes(C, Accuracy)) + ggtitle("SVM Lineal Modelo 2")
...
C_binaria <- expand.grid(C=c(0.001,0.005,0.01,0.02,0.03,0.05,0.1))
...
ggplot(svm_poly_5_rep[svm_poly_5_rep$Modelo == 1, ], aes(x = factor(C), y = Accuracy,
                                                        color = factor(scale), pch = factor(scale))) + 
  geom_point(position = position_dodge(width = 0.5), size = 3) + 
  ggtitle("SVM Polinomial Modelo 1 (Grado 2)")
...
svm_poly_5_rep[svm_poly_5_rep$Modelo == 2, ] %>% ggplot(aes(x = factor(C), y = Accuracy,
                                                            color = factor(scale), pch = factor(scale))) + 
  geom_point(position = position_dodge(width = 0.5), size = 3) + 
  ggtitle("SVM Polinomial Modelo 2 (Grado 2)")
...
svm_pol_2_2 <- cruzadaSVMbinPoly(data=surgical_dataset, vardep=target,
                                 listconti = var_modelo2, listclass=c(""),
                                 grupos=5,sinicio=1234,repe=5,C = C_poly_2,
                                 degree = degree_poly_2, scale = scale_poly_2,
                                 label = "Modelo 2")
...
ggplot(svm_poly_5_rep_v2[svm_poly_5_rep_v2$Modelo == 1, ], aes(x = factor(C), y = Accuracy,
                                                         color = factor(scale), pch = factor(scale))) + 
  geom_point(position = position_dodge(width = 0.5), size = 3) + 
  ggtitle("SVM Polinomial Modelo 1 (Grado 2)")
...
# Elegimos un factor C = 5 y escala = 1

# Modelo 2
ggplot(svm_poly_5_rep_v2[svm_poly_5_rep_v2$Modelo == 2, ], aes(x = factor(C), y = Accuracy,
                                                               color = factor(scale), pch = factor(scale))) + 
  geom_point(position = position_dodge(width = 0.5), size = 3) + 
  ggtitle("SVM Polinomial Modelo 2 (Grado 2)")
...
# Modelo 1
ggplot(svm_rbf_5_rep[svm_rbf_5_rep$Modelo == 1, ], aes(x = factor(C), y = Accuracy,
                                                       color = factor(sigma))) + 
  geom_point(position = position_dodge(width = 0.5), size = 3) +
  ggtitle("SVM RBF Modelo 1")
...
ggplot(svm_rbf_5_rep[svm_rbf_5_rep$Modelo == 2, ], aes(x = factor(C), y = Accuracy,
                                                       color = factor(sigma))) + 
  geom_point(position = position_dodge(width = 0.5), size = 3) +
  ggtitle("SVM RBF Modelo 2")
...
# Modelo 1
ggplot(svm_rbf_5_rep_v2[svm_rbf_5_rep_v2$Modelo == 1, ], aes(x = factor(C), y = Accuracy,
                                                       color = factor(sigma))) + 
  geom_point(position = position_dodge(width = 0.5), size = 3) +
  ggtitle("SVM RBF Modelo 1")
...
# Modelo 2
ggplot(svm_rbf_5_rep_v2[svm_rbf_5_rep_v2$Modelo == 2, ], aes(x = factor(C), y = Accuracy,
                                                       color = factor(sigma))) + 
  geom_point(position = position_dodge(width = 0.5), size = 3) +
  ggtitle("SVM RBF Modelo 2")
...
SVM_polinomial_modelo1 <- train(as.formula(paste0(target,"~",paste0(var_modelo1, collapse = "+"))),
                                ...
                                tuneGrid=expand.grid(C=5,degree=2,scale=1),
                                replace=TRUE)

SVM_poly_modelo1_df    <- cruzadaSVMbinPoly(surgical_dataset, vardep=target, listconti=var_modelo1,
                                            listclass = c(""), grupos=5, repe=10, C=5, degree=2,
                                            scale=1, sinicio=1234, label = "Modelo 1")
...
SVM_poly_modelo2_df    <- cruzadaSVMbinPoly(surgical_dataset, vardep=target, listconti=var_modelo2,
                                            ...
                                            scale=0.1, sinicio=1234, label = "Modelo 2")
...
ggplot(svm_10_rep_modelo1, aes(x = modelo, y = tasa)) +
...
ggplot(svm_10_rep_modelo1, aes(x = modelo, y = auc)) +
  geom_boxplot(fill = "#4271AE", colour = "#1F3552",
               alpha = 0.7) +
  scale_x_discrete(name = "Modelo") +
